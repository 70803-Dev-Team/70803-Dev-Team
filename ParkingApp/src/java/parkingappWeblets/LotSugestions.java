        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (dbUser.compareTo(currentUser)){
                ...
                "                <div class=\"parkingLotList\">\n");
                        for (int i = 1; i <=4; i++){
                            out.println("<h2>ParkingLotResult" + i + "</h2>\n");
                            out.println(db.getRating("ParkingLotResult"+i)+"(out of 5) full");
                            out.println("<li><a href=\"RateLot?LotName=ParkingLotResult" + i + "\">Rate Lot</a></li>");

                        }
                out.println("</div>\n" +
                "            <p class=\"rateLot\">\n" +
                "                <a href=\"ParkingApp.html\">Find a Parking Lot!</a>\n" +
                "            </p>\n" +
                "        </div>  \n" +
                "        <div id='map'></div>\n" +
                "    </body>\n" +
